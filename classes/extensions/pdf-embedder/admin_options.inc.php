				...
				<div class="submit">
					<?php if ( $license_manager->get_license_is_activated( OptionLicenses::LICENSE_PACKAGE_PDF_EMBEDDER ) ) { ?>
						<div class="wpsolr_premium_block_class">
							<?php echo $license_manager->show_premium_link( OptionLicenses::LICENSE_PACKAGE_PDF_EMBEDDER, OptionLicenses::TEXT_LICENSE_ACTIVATED, true, true ); ?>
						</div>
					...
					<?php } else { ?>
						<?php echo $license_manager->show_premium_link( OptionLicenses::LICENSE_PACKAGE_PDF_EMBEDDER, 'Save Options', true, true ); ?>
						<br/>
					<?php } ?>
				</div>
			</div>
