			...
			<div class='wdm_row'>
				<div class="submit">
					<?php if ( $license_manager->get_license_is_activated( OptionLicenses::LICENSE_PACKAGE_BBPRESS ) ) { ?>
						<div
							class="wpsolr_premium_block_class"><?php echo $license_manager->show_premium_link( OptionLicenses::LICENSE_PACKAGE_BBPRESS, OptionLicenses::TEXT_LICENSE_ACTIVATED, true, true ); ?></div>
					...
					<?php } else { ?>
						<?php echo $license_manager->show_premium_link( OptionLicenses::LICENSE_PACKAGE_BBPRESS, 'Save Options', true, true ); ?>
						<br/>
					<?php } ?>
				</div>
			</div>
