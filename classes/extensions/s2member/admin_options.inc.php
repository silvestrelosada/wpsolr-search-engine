			...
			<div class="wdm_row">
				...
				<div class='col_right'>
					<input type='checkbox'
						...
						<?php checked( 'is_extension_active', isset( $solr_extension_s2member_options['is_extension_active'] ) ? $solr_extension_s2member_options['is_extension_active'] : '' ); ?>>
				</div>
				<div class="clear"></div>
			</div>
			<div class="wdm_row">
				...
				<div class='col_right'>
					<input type='checkbox'
						...
						<?php checked( 'is_users_without_capabilities_see_all_results', isset( $solr_extension_s2member_options['is_users_without_capabilities_see_all_results'] ) ? $solr_extension_s2member_options['is_users_without_capabilities_see_all_results'] : '' ); ?>>
				</div>
				<div class="clear"></div>
			</div>
			<div class="wdm_row">
				...
				<div class='col_right'>
					<input type='checkbox'
						...
						<?php checked( 'is_result_without_capabilities_seen_by_all_users', isset( $solr_extension_s2member_options['is_result_without_capabilities_seen_by_all_users'] ) ? $solr_extension_s2member_options['is_result_without_capabilities_seen_by_all_users'] : '' ); ?>>
				</div>
				<div class="clear"></div>
			</div>
			<div class="wdm_row">
