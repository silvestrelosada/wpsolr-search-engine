...
function add_scripts() {
	...
	wp_enqueue_style( 'solr_frontend', plugins_url( 'css/style.css', __FILE__ ), array() , '5.8.3' );
	wp_enqueue_script( 'solr_auto_js1', plugins_url( 'js/bootstrap-typeahead.js', __FILE__ ), array( 'jquery' ), '5.8.3', true );
	wp_enqueue_script( 'solr_autocomplete', plugins_url( 'js/autocomplete_solr.js', __FILE__ ), array( 'solr_auto_js1' ), '5.8.3', true );
}
